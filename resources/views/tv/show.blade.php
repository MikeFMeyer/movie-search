...
@section('content')
    <div class="tv-info border-b border-gray-800" style="background-image: url({{ $tvshow['backdrop_path'] }});
        ...
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="md:ml-24">
                ...
                <div class="flex flex-wrap items-center text-gray-400 text-sm">
                    <svg class="fill-current text-with-gradient w-4" viewBox="0 0 24 24">
                        <g data-name="Layer 2">
                            <path
                    ...
                    @if (count($tvshow['videos']['results']) > 0)
                        <div class="mt-12">
                            <button @click="isOpen = true"
                                class="flex inline-flex items-center bg-with-gradient text-gray-900 rounded font-semibold px-5 py-4 hover:bg-orange-600 transition ease-in-out duration-150">
